...
export const SignupPage = () => {
  ...
  const handleSignupSuccess = useCallback(async (user: UserType) => {
    login(user);
          ...
          {!showEmailForm ? (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-primary-600 text-white py-3 rounded-lg font-medium hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all flex items-center justify-center gap-3"
              >
